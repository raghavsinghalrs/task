export const initialBaseObject = {
...
export const initialPatches = [
  ...
  { op: "replace", path: "/tags/2", value: "tcs10k-18" },
  { op: "replace", path: "/tags/1", value: "lfc18-cbp" },
  { op: "replace", path: "/tags/0", value: "lfc18" },
  { op: "add", path: "/tags/6", value: "housie18" },
  { op: "add", path: "/tags/7", value: "hoh18" },
  { op: "add", path: "/tags/8", value: "lfc19" },
  { op: "add", path: "/tags/9", value: "tbpp" },
  { op: "add", path: "/tags/10", value: "housie19" },
  { op: "add", path: "/tags/11", value: "gfc2020" },
  {
    op: "replace",
    path: "/external_profiles/1/uri",
    value: "https://www.facebook.com/pages/DIYA-Foundation/",
  },
  { op: "replace", path: "/external_profiles/1/label", value: "Facebook" },
  {
    op: "add",
  ...
  { op: "add", path: "/official_name", value: "Diya Foundation" },
];
